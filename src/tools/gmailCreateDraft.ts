import { createDraft } from '../services/gmailService.js';
import { GmailCreateDraftArgs, ToolResponse } from '../types.js';

export async function handleGmailCreateDraft(args: any): Promise<ToolResponse> {
  ...
  try {
    const data = await createDraft(args as GmailCreateDraftArgs);
